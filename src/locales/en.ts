export default {
  ...
  login: {
    ...
    accountSubtitle: 'Use your enterprise account to access the platform',
    visualTitle: 'Keep data moving through your business',
    visualDescription: 'Connect data, workflows, and services with clarity and control.',
    capabilityCatalog: 'Data catalog',
    capabilityApi: 'API services',
    ...
    tenantSelectPlaceholder: 'Please Select Tenant',
