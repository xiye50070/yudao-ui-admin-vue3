export default {
  ...
  login: {
    ...
    accountWelcome: '欢迎登录',
    accountSubtitle: '使用企业账号访问业务中台',
    visualTitle: '让数据在业务中台顺畅流动',
    visualDescription: '统一连接数据、流程与服务，让协作始终清晰可控。',
    capabilityCatalog: '数据目录',
    capabilityApi: 'API 服务',
    capabilityWorkflow: '流程审批',
    capabilitySecurity: '安全治理',
    tenantname: '租户名称',
    username: '用户名',
    password: '密码',
    code: '验证码',
